...
module pll_2xq_5x (clki_i, 
    ...
    output clkos5_o ; 
    output lock_o ; 
    pll_2xq_5x_ipgen_lscc_pll #(.INTFBKDEL_SEL("DISABLED"),
            ...
            .CLKOS2_BYPASS(0),
            .ENCLKOS2_EN(0),
            .CLKOS2_FREQ_ACTUAL(50.0),
            .CLKOS2_PHASE_ACTUAL(0.0),
            .DIVOS2_ACTUAL_STR("31"),
            .DELC("31"),
            .PHIC("0"),
            .CLKOS3_EN(1),
            .CLKOS3_BYPASS(0),
...
// Module : lscc_pll
//==========================================================================
module pll_2xq_5x_ipgen_lscc_pll #(parameter FVCO = 800.0, 
    ...
    generate
        if ((APB_EN == 1)) 
            begin : APB2LMMI_INST
                ...
                ///
                pll_2xq_5x_ipgen_lscc_apb2lmmi #(.DATA_WIDTH(8),
                        .ADDR_WIDTH(7),
...
//==========================================================================
module pll_2xq_5x_ipgen_lscc_apb2lmmi #(parameter DATA_WIDTH = 32, 
